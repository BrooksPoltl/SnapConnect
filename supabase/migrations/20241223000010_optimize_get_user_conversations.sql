-- Migration: Optimize Get User Conversations
-- Description: Rewrites the get_user_conversations function for improved performance
-- by simplifying joins and reducing subquery complexity.
...
-- ============================================================================
-- REWRITE GET_USER_CONVERSATIONS FOR PERFORMANCE
-- ============================================================================
...
BEGIN
    ...
    WITH conversations_with_details AS (
        -- Step 1: Get all chats the user is part of and identify the other user
        SELECT
            c.id AS chat_id,
